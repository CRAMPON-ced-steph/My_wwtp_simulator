// SQUELETTE — port de E9_Biostyr_PDN.cls à réaliser (source VBA : vba-source/E9_Biostyr_PDN.cls).
...
export default passthrough({
  ...
  description: "Biofiltre BIOSTYR en post-dénitrification (méthanol) en second étage.",
  params: [
